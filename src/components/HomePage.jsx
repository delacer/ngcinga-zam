...
// 1. Import Link from react-router-dom to swap slow anchor reloads for instant hydration
import { Link } from "react-router-dom";
import { FaTools, FaHardHat, FaPhoneAlt, FaArrowRight, FaQuoteLeft, FaStar } from "react-icons/fa";
    ...
    <>
      ...
      <div className="hero-section">
        ...
        <nav className="navbar">
          ...
          {/* Replaced <a> tags with <Link to="..."> for instantaneous navigation */}
        ...
        <div className="hero-text">
          ...
          <h1>
            Building with Precision,<br />Passion and Integrity
          </h1>
          <p>
            Industrial-grade welding, custom artisan carpentry, and turn-key general construction solutions across Cape Town.
          </p>
        ...
        <div className="service-snapshot-wrapper">
          <div className="service-snap-card">
            <div className="snap-img-box">
              <img src="/welding.jpeg" alt="Precision Welding service" />
            </div>
          ...
          <div className="service-snap-card">
            <div className="snap-img-box">
              <img src="/carpentry.jpeg" alt="Artisan Carpentry service" />
            </div>
            <div className="snap-content">
          ...
          <div className="service-snap-card">
            <div className="snap-img-box">
              <img src="/construction.jpeg" alt="General Construction service" />
            </div>
            <div className="snap-content">
      ...
      <main className="homepage-content-wrapper">
        ...
        <section className="about-preview-section">
          <div className="about-preview-grid">
            ...
            <div className="about-preview-text">
              ...
              <p>
                Derived from the isiXhosa phrase meaning <strong>"My Thoughts"</strong>, Ngcinga Zam (Pty) Ltd was founded on the fundamental principle that every iconic, structural build starts with an intelligent, deliberate idea.
              </p>
              <p>
                From small-scale residential carpentry fittings, we have grown into a multi-disciplinary fabrication and construction outfit trusted by homeowners and commercial site developers alike across the Western Cape.
              </p>
          ...
          <div className="featured-projects-grid">
            <div className="project-display-card">
              <div className="project-image-box">
                <img src="/fcupboards.jpeg" alt="Modern luxury built-in cupboards" />
              </div>
            ...
            <div className="project-display-card">
              <div className="project-image-box">
                <img src="/fcarpentry.jpeg" alt="Precision designed modern Nutec house layout" />
              </div>
              <div className="project-label-overlay">
            ...
            <div className="project-display-card">
              <div className="project-image-box">
                <img src="/fgate.jpeg" alt="Heavy steel architectural driveway gate" />
              </div>
              <div className="project-label-overlay">
        ...
        {/* HIGH CONTRAST WHY CHOOSE US AREA - GLASS FEATURE ENABLED */}
          ...
          <div className="choose-us-glass-grid">
            <div className="choose-glass-card">
              <div className="icon-circle-wrapper">
                <Award className="choose-icon" size={26} />
              </div>
            ...
            <div className="choose-glass-card">
              <div className="icon-circle-wrapper">
                <ShieldCheck className="choose-icon" size={26} />
              </div>
            ...
            <div className="choose-glass-card">
              <div className="icon-circle-wrapper">
                <Clock className="choose-icon" size={26} />
              </div>
        ...
        <section className="testimonials-section">
          ...
          <div className="testimonials-masonry-grid">
            {testimonials.map((item) => (
              <div className="testimonial-item-card" key={item.id}>
        ...
        <section className="contact-callout-panel">
          <div className="callout-inner-content">
            ...
            <p>
              Partner with an agile, reliable South African contracting team. Reach out to Ngcinga Zam (Pty) Ltd today to set up your onsite layout estimation or structural quote consult.
            </p>
